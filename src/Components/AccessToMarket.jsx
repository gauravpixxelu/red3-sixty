                    ...
                    <div className="row">
                        ...
                        <div className="col-md-5">
                            <div className="businessess-block-growth">
                                ...
                                <img src="/images/access-market.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-content col3-tab" id="nav-tabContent">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/access-tab-1.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="module2" role="tabpanel" aria-labelledby="module2-tab">
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/quick-profit.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="module3" role="tabpanel" aria-labelledby="module3-tab">
                           <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/proposal-success.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="module4" role="tabpanel" aria-labelledby="module4-tab">
                           <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/proposal-su.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="module5" role="tabpanel" aria-labelledby="module5-tab">
                           <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/value-propostion.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="module7" role="tabpanel" aria-labelledby="module7-tab">
                           <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/pricing-profit.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="module8" role="tabpanel" aria-labelledby="module8-tab">
                             <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/market-access.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="module9" role="tabpanel" aria-labelledby="module9-tab">
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/future-growth.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="module10" role="tabpanel" aria-labelledby="module10-tab">
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/irrestible-offer.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="module11" role="tabpanel" aria-labelledby="module11-tab">
                           <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="tab-img">
                                        <img src="/images/irstible-offer.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
