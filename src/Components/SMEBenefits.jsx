    ...
    return (
        <div className="sme-benefit-page">
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <div className="sme-box">
                                    <img src="icons/benefit-1.svg" alt="" />
                            ...
                            <div className="col-md-4">
                                <div className="sme-box">
                                    <img src="icons/benefit-2.svg" alt="" />
                            ...
                            <div className="col-md-4">
                                <div className="sme-box">
                                    <img src="icons/benefit-3.svg" alt="" />
            ...
            <section className="acc-block">
                <div className="container">
                    <h2 className="sec-hdng">What are the benefits for your customer using the diagnostic report or development modules?</h2>
